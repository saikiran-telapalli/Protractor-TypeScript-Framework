...
function TinyTypeOf() {
    return /** @class */ (function (_super) {
        ...
        function class_1(value) {
            ...
            _this.value = value;
            (0, ensure_1.ensure)(_this.constructor.name, value, (0, predicates_1.isDefined)());
            return _this;
        }
        return class_1;
    }(TinyType));
...
var TinyType = /** @class */ (function () {
    ...
    TinyType.prototype.toJSON = function () {
        var _this = this;
        var fields = (0, objects_1.significantFieldsOf)(this);
        if (fields.length === 1) {
...
function mapToJSON(map) {
    var serialised = Array.from(map, function (_a) {
        var key = _a[0], value = _a[1];
        return [toJSON(key), toJSON(value)];
    });
    return Object.fromEntries(serialised);
}
function recordToJSON(value) {
    var serialised = Object.entries(value)
        .map(function (_a) {
        var k = _a[0], v = _a[1];
        return [toJSON(k), toJSON(v)];
    });
    return Object.fromEntries(serialised);
}
